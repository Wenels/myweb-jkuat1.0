...
import { Home, ShoppingBag, ShoppingCart, Heart, User } from "lucide-react"; // Import icons from lucide-react library
      ...
      <nav className="flex items-center justify-around bg-[#192137] border-b border-white/10 px-6 py-2 shadow-2xl">
        ...
        {NAV_ITEMS.map(({ icon: Icon, label }) => (
          <button
            ...
            className={`flex flex-col items-center justify-center gap-1 px-5 py-2 rounded-xl transition-all duration-200 min-w-[64px] ${active === label
